    ...
    <div style={{ minHeight: "100dvh", background: "#0A2342", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, padding: "2.5rem 1.5rem", maxWidth: 680, margin: "0 auto", width: "100%" }}>
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          ...
          <p style={{ color: "rgba(230,230,230,0.65)", fontFamily: "'Inter', sans-serif", fontSize: "0.88rem", lineHeight: 1.7, maxWidth: 500, margin: "0 auto" }}>The DRU Scale System™ is launching soon — the exact system DeAnna used to build a global AI consulting empire. Join the waitlist to be first in.</p>
        </div>
        ...
        <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(212,175,55,0.2)", borderRadius: 12, padding: "1.5rem", marginBottom: "2rem" }}>
          ...
          {!submitted ? (
            ...
            <div style={{ background: "rgba(67,160,71,0.08)", border: "1px solid rgba(67,160,71,0.3)", borderRadius: 6, padding: "0.75rem", textAlign: "center" }}>
              <p style={{ fontFamily: "'Montserrat', sans-serif", color: "#43A047", fontWeight: 700, fontSize: "0.8rem" }}>You are on the waitlist! We will be in touch.</p>
            </div>
          )}
        </div>
        ...
        <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(212,175,55,0.15)", borderRadius: 12, padding: "1.5rem" }}>
          ...
          <p style={{ color: "rgba(230,230,230,0.8)", fontFamily: "'Inter', sans-serif", fontSize: "0.82rem", lineHeight: 1.75, marginBottom: "1rem" }}>The exact system DeAnna used to build a global AI consulting empire — now available for entrepreneurs and consultants ready to scale with AI.</p>
          {["8 core modules — self-paced with lifetime access", "Live group coaching calls with DeAnna", "GHL white label affiliate setup included", "AI tools stack — Manus, Lovable, Claude", "Build your own IP framework", "Revenue while you sleep architecture"].map((f, i) => (
        ...
        <div style={{ marginTop: "2rem", textAlign: "center", padding: "1.5rem", background: "rgba(212,175,55,0.04)", border: "1px solid rgba(212,175,55,0.12)", borderRadius: 10 }}>
          <p style={{ fontFamily: "'Playfair Display', serif", color: "#D4AF37", fontSize: "0.95rem", fontStyle: "italic", lineHeight: 1.8 }}>"I walk with purpose, lead with AI authority, and empower transformation through effective AI."</p>
