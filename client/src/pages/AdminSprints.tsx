...
const SPRINTS: { number: string; title: string; status: string; items: SprintItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { done: false, label: "L1 — Feed (Home) page", sub: "Reads same community Supabase tables · agent posts · heart + comment interactions" },
      { done: false, label: "L1 — Start Here checklist", sub: "7 steps · agent-written static content · completion tracked in Supabase" },
      ...
      { done: false, label: "L1 — Lesson player", sub: "Bunny Stream video · right lessons panel · module/lesson outline · ✓ Completed button" },
      { done: false, label: "L1 — Acc Monthly Videos page", sub: "Monthly Leadership Lab! archive · Accelerator-gated · Navigator sees upgrade CTA" },
      { done: false, label: "L1 — Leaderboard", sub: "Reads existing community_leaderboard view · Clarity Points™ · Connected → Changemaker levels" },
      { done: false, label: "L1 — Resources section", sub: "Framework PDFs · AI Insights Archive · Tool Guides · Weekly PDF (Accelerator only)" },
      { done: false, label: "L1 — Support Hub", sub: "Chat widget OR email form · decision at build time" },
      ...
      { done: false, label: "L2 — api/course-enrollment.ts serverless function", sub: "GHL webhook → Supabase account auto-created → tier assigned → magic link sent" },
      { done: false, label: "L2 — GHL workflows (3 tiers)", sub: "self_paced · live_cohort · mastermind · each fires webhook" },
      { done: false, label: "L2 — Supabase magic link redirect", sub: "Redirect URL: courses.druaiconsulting.com/courses" },
      { done: false, label: "L3 — Lesson titles confirmed", sub: "3–5 lessons per week · 4 weeks · DeAnna approves" },
      { done: false, label: "L3 — Agent insights per lesson", sub: "Generated by agents in DeAnna's brand voice · reviewed + approved" },
      { done: false, label: "L3 — Firefly agent photos (54 agents)", sub: "Generate in Adobe Firefly · Jordan/Ravi approve · upload to Supabase Storage" },
      { done: false, label: "L3 — HeyGen Photo Avatars created", sub: "One per delivering agent · Creator plan · 200 credits/mo" },
      { done: false, label: "L3 — Lesson videos produced (Amelia/HeyGen)", sub: "Path A: talking head · Path B: voice over slides" },
      { done: false, label: "L3 — Videos uploaded to Bunny Stream", sub: "Bunny Library ID added · embed URL format wired into lesson player" },
      { done: false, label: "L3 — Lesson content entered via /admin", sub: "All Bunny video IDs + agent insights + resources entered per lesson" },
      { done: false, label: "L3 — Tier-gated bonus content", sub: "Live Cohort + Mastermind bonus sections locked for self_paced" },
    ],
  },
  {
