 ...
 * EmailVerification.ts — Disposable domains, typo detection, MX record check
 */
...
export const DISPOSABLE_DOMAINS = new Set([
  ...
  "10minutemail.com","10minutemail.net","fakeinbox.com","fakemailgenerator.com",
  "guerrillamailblock.com","sharklasers.com","grr.la","spam4.me","spamgourmet.com",
  "mohmal.com","mytemp.email","nada.email","gmial.com","gmal.com","gmai.com",
  "gmali.com","gmaill.com","yahooo.com","yahho.com","yaho.com","hotmial.com",
  "hotmal.com","hotmai.com","outlok.com","outloo.com",
]);
...
export async function verifyEmail(
  ...
  if (!hasMx)
    return {
      valid: false,
      error: `No mail server found for "${domain}". Please check your email address.`,
    };
