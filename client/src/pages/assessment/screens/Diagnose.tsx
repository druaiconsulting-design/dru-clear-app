...
export function DiagnoseScreen({
  ...
  const executiveFeatures = [
    ...
    "Comprehensive gap analysis, including risk assessment",
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "1rem", marginBottom: "1.25rem" }}>
        ...
        {/* Executive — BEST VALUE */}
        <div
          onClick={() => setSelected("executive")}
          style={{ background: selected === "executive" ? "rgba(212,175,55,0.08)" : "rgba(255,255,255,0.04)", border: `2px solid ${selected === "executive" ? "#D4AF37" : "rgba(212,175,55,0.3)"}`, borderRadius: 10, padding: "1.25rem", cursor: "pointer", position: "relative", transition: "all 0.2s" }}
        >
          ...
          <button className="btn-magenta" onClick={(e) => { e.stopPropagation(); onSelectExecutive(); }} style={{ fontSize: "0.82rem" }}>
        ...
        <div
          ...
          style={{ background: selected === "strategic" ? "rgba(212,175,55,0.06)" : "rgba(255,255,255,0.03)", border: `1.5px solid ${selected === "strategic" ? "rgba(212,175,55,0.6)" : "rgba(212,175,55,0.2)"}`, borderRadius: 10, padding: "1.25rem", cursor: "pointer", transition: "all 0.2s" }}
        >
          ...
          <button className="btn-magenta" onClick={(e) => { e.stopPropagation(); onSelectStrategic(); }} style={{ fontSize: "0.82rem" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: "1rem" }}>
        <button
          ...
          style={{ background: "none", border: "none", color: "rgba(212,175,55,0.65)", fontSize: "0.75rem", textDecoration: "underline", textUnderlineOffset: 3, cursor: "pointer", fontFamily: "'Montserrat', sans-serif", fontWeight: 600 }}
        >
          → Not ready yet? Continue to Share Your Results
        </button>
      </div>
    </div>
  );
