 ...
 * CountryCodeSelector.tsx — Country data, timezone detection, selector UI
 */
...
const TIMEZONE_TO_ISO: Record<string, string> = {
  ...
  "America/Santiago": "CL","America/Caracas": "VE","Europe/London": "GB",
  ...
  "Europe/Helsinki": "FI","Europe/Warsaw": "PL","Europe/Moscow": "RU",
  "Europe/Istanbul": "TR","Europe/Athens": "GR","Asia/Tokyo": "JP",
  "Asia/Seoul": "KR","Asia/Shanghai": "CN","Asia/Hong_Kong": "HK",
  "Asia/Singapore": "SG","Asia/Kolkata": "IN","Asia/Dubai": "AE",
  "Asia/Riyadh": "SA","Australia/Sydney": "AU","Australia/Melbourne": "AU",
  "Australia/Brisbane": "AU","Pacific/Auckland": "NZ","Africa/Cairo": "EG",
  ...
  return (
    <div ref={containerRef} style={{ position: "relative", flexShrink: 0 }}>
      <button
        ...
        style={{
          display: "flex", alignItems: "center", gap: "0.35rem", height: "100%",
          padding: "0 0.65rem", background: "rgba(255,255,255,0.05)",
          border: "1px solid rgba(212,175,55,0.3)", borderRadius: 4,
          color: "#FFFFFF", cursor: "pointer", fontSize: "0.85rem",
          whiteSpace: "nowrap", transition: "border-color 0.2s", minWidth: 72,
        }}
      ...
      {open && (
        <div style={{
          ...
          background: "#0d2d52", border: "1px solid rgba(212,175,55,0.3)",
          borderRadius: 6, boxShadow: "0 8px 32px rgba(0,0,0,0.5)",
          width: 240, maxHeight: 280, display: "flex", flexDirection: "column", overflow: "hidden",
        }}>
          <div style={{ padding: "0.5rem 0.6rem", borderBottom: "1px solid rgba(212,175,55,0.15)" }}>
            <input
              ...
              style={{
                ...
                padding: "0.35rem 0.6rem", color: "#FFFFFF",
          ...
          <div style={{ overflowY: "auto", flex: 1 }}>
            {filtered.length === 0 ? (
              <p style={{ padding: "0.75rem", color: "rgba(230,230,230,0.4)", fontSize: "0.75rem", textAlign: "center" }}>
                No results
              </p>
            ) : (
              filtered.map((c) => (
