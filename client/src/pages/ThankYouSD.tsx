    ...
    <div style={{ minHeight: "100dvh", background: "#0A2342", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, padding: "2.5rem 1.5rem 3rem", maxWidth: 520, margin: "0 auto", width: "100%" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", marginBottom: "1rem" }}>
          <span style={{ background: "rgba(212,175,55,0.15)", color: "#D4AF37", fontFamily: "'Montserrat', sans-serif", fontSize: "0.62rem", fontWeight: 700, letterSpacing: "0.1em", padding: "3px 16px", borderRadius: 20, textTransform: "uppercase", border: "1px solid rgba(212,175,55,0.35)" }}>Strategic Diagnostic</span>
        </div>
        ...
        <p style={{ fontFamily: "'Inter', sans-serif", color: "rgba(230,230,230,0.4)", fontSize: "0.65rem", textAlign: "center", marginBottom: "2rem", lineHeight: 1.6 }}>
          Having trouble?{" "}
          <a href={CALENDAR_STRATEGIC_URL} target="_blank" rel="noopener noreferrer" style={{ color: "#D4AF37", textDecoration: "underline" }}>
            Open booking page
          </a>
        </p>
