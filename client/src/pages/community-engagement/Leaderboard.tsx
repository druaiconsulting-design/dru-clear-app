    ...
    return (
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', minWidth: 0 }}>
          ...
          <div style={{ minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', flexWrap: 'wrap' }}>
              <span style={{ fontFamily: "'Montserrat', sans-serif", fontSize: '13px', fontWeight: '600', color: '#0A2342', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '140px' }}>
        ...
        <div style={{ textAlign: 'right', flexShrink: 0 }}>
          <div style={{ fontFamily: "'Montserrat', sans-serif", fontSize: '14px', fontWeight: '700', color: '#0A2342' }}>
            {p?.toLocaleString() ?? '—'}
          </div>
      ...
      <main style={{ flex: 1, padding: '40px 24px 80px' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '20px', padding: '12px 16px', background: '#FAFAF8', border: '1px solid #E8E4DF', borderRadius: '8px' }}>
              {[
                ...
                <div key={s.label} style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <span style={{ display: 'inline-block', fontSize: '10px', fontWeight: '700', fontFamily: "'Montserrat', sans-serif", padding: '2px 8px', borderRadius: '4px', background: s.bg, color: s.color }}>
                    {s.label}
                  </span>
                  <span style={{ fontFamily: "'Montserrat', sans-serif", fontSize: '11px', color: 'rgba(10,35,66,0.4)' }}>
                    {s.tip}
                  </span>
                </div>
              ))}
            ...
            {!loading && myRow && (
              <>
                <div style={{ padding: '6px 20px', background: '#F5F3EF', borderTop: '1px dashed #E8E4DF' }}>
                  <span style={{ fontFamily: "'Montserrat', sans-serif", fontSize: '10px', fontWeight: '600', color: 'rgba(10,35,66,0.4)', letterSpacing: '0.5px' }}>
                    YOUR RANK
                  </span>
                </div>
          ...
          <div style={{ padding: '14px 20px', background: '#FAFAF8', border: '1px solid #E8E4DF', borderRadius: '10px', display: 'flex', gap: '24px', flexWrap: 'wrap', alignItems: 'center' }}>
            <span style={{ fontFamily: "'Montserrat', sans-serif", fontSize: '11px', fontWeight: '600', color: 'rgba(10,35,66,0.4)', letterSpacing: '0.5px', flexShrink: 0 }}>
              EARN POINTS:
            </span>
            {[
