            ...
            <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(212,175,55,0.25)", borderRadius: 14, overflow: "hidden" }}>
              ...
              <div style={{ padding: "1.25rem 1.5rem" }}>
                ...
                <a href={NAVIGATOR_PAYMENT_LINK} target="_blank" rel="noopener noreferrer"
                  style={{ display: "block", width: "100%", background: "transparent", border: "1.5px solid #D4AF37", borderRadius: 8, padding: "0.85rem", fontFamily: "'Montserrat', sans-serif", fontWeight: 700, fontSize: "0.78rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "#D4AF37", textAlign: "center", textDecoration: "none", boxSizing: "border-box" as const }}>
            ...
            <div style={{ background: "rgba(194,24,91,0.06)", border: "2px solid rgba(194,24,91,0.5)", borderRadius: 14, overflow: "hidden" }}>
              ...
              <div style={{ padding: "1.25rem 1.5rem" }}>
                ...
                <a href={ACCELERATOR_PAYMENT_LINK} target="_blank" rel="noopener noreferrer"
                  style={{ display: "block", width: "100%", background: "#C2185B", border: "none", borderRadius: 8, padding: "0.85rem", fontFamily: "'Montserrat', sans-serif", fontWeight: 700, fontSize: "0.78rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "#FFFFFF", textAlign: "center", textDecoration: "none", boxSizing: "border-box" as const }}>
