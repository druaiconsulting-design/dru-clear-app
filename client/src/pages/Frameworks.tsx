...
const FRAMEWORKS = [
  ...
  },
  {
    ...
    theme: null,
    intro: "Most leadership development programs focus on skills. 5D Leadership™ focuses on the whole leader — building from the inside out across five critical dimensions that determine whether leadership actually transforms an organization or just manages it.\n\nThis AI-infused leadership methodology ensures that personal mastery, team effectiveness, organizational strength, and strategic impact all develop together — not in isolation. Because a leader who hasn't mastered themselves cannot effectively lead people. A leader who can't lead people cannot build a team. A leader who can't build a team cannot strengthen an organization. And an organization without visionary leadership cannot dominate in the AI era.",
    dimensions: [
  ...
  },
  {
    ...
    dimensions: [
      ...
      { label: "Close with Confidence, Not Pressure", desc: "Confidence comes from clarity. When you know your client's behavioral style and your AI is working alongside you, closing becomes a natural next step — not a push." },
      ...
      <main style={{ flex: 1, padding: "2.5rem 1.5rem", maxWidth: 680, margin: "0 auto", width: "100%" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          ...
          <p style={{ color: "rgba(230,230,230,0.65)", fontFamily: "'Inter', sans-serif", fontSize: "0.88rem", lineHeight: 1.7, maxWidth: 500, margin: "0 auto" }}>
            Original IP designed to move organizations from AI uncertainty to AI authority — at every level of leadership. Each framework can be engaged individually, in pairs, or as a complete ecosystem.
          </p>
        </div>
          ...
          {FRAMEWORKS.map((fw) => (
            <div key={fw.id} style={{
              ...
              <div style={{ padding: "1.25rem 1.5rem 1rem", borderBottom: "1px solid rgba(212,175,55,0.1)" }}>
                ...
                {fw.theme && (
                  <p style={{ fontFamily: "'Inter', sans-serif", color: "#D4AF37", fontSize: "0.75rem", fontStyle: "italic", marginTop: "0.5rem", opacity: 0.85 }}>{fw.theme}</p>
                )}
              </div>
              ...
              <div style={{ padding: "1.25rem 1.5rem" }}>
                {/* Intro paragraphs */}
                {fw.intro.split("\n\n").map((para, i) => (
                  <p key={i} style={{ color: "rgba(230,230,230,0.8)", fontFamily: "'Inter', sans-serif", fontSize: "0.82rem", lineHeight: 1.75, marginBottom: "1rem" }}>{para}</p>
                ))}
