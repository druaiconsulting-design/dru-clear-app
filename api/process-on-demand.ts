...
If you see a bracketed note like [DEANNA: ...], that is Kwame correctly asking DeAnna for a specific detail neither he nor Chloe had -- a vendor name, an exact cost, a date. It is not an invented claim and not a voice problem -- leave it exactly as written; do not flag it.`;
    }
  }
