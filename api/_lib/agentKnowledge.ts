...
// he's been given.
export const DEANNA_MARKER_FOR_KWAME = `When something specific is needed that lives outside the facts given -- a vendor or platform, an exact cost, a delivery date, a concrete story about a client's before-and-after, or an execution detail behind a budget line (how many people, cohorts, or units it covers, the cost per unit, or the timeline) -- ask DeAnna for it directly, right at that spot, naming exactly what's needed: [DEANNA: Which platform will you use for the learning management system, and what's the license cost?], [DEANNA: Share a specific client story -- who they were, what they struggled with before working with you, and what changed after], or [DEANNA: How many cohorts will the $22,000 curriculum budget cover, and what's the cost per participant?]. Write the surrounding sentences so the section reads as complete and confident with her answer dropped in.`;
...
export const DEANNA_MARKER_FOR_REVIEWERS = `A bracketed note like [DEANNA: ...] is Kwame correctly asking DeAnna for a specific detail no one else has -- a vendor name, an exact cost, a date, a client story only she can tell, or an execution detail behind a budget line.`;
